...
namespace QuotesApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<QuotesDbContext>(options => options.UseSqlServer(@"Data Source = sachin3147429-1; Initial Catalog = QuotesDB;Trusted_Connection=True"));
            ...
            {
                options.Authority = "https://vega123.auth0.com/";
                options.Audience = "http://localhost:58947/";
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, QuotesDbContext quotesDbContext)
        {
            ...
            //quotesDbContext.Database.EnsureCreated();  //  use this when you are sure that once database created will never changed.
